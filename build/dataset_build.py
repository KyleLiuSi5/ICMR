...
if __name__ == "__main__":
    fr = open("../../dataset/ivslab_train/ImageSets/All.txt", "r")
    fwi = open("../../dataset/ivslab_train/ImageSets/images.txt", "w+")
    fwl = open("../../dataset/ivslab_train/ImageSets/labels.txt", "w+")
    convert("../../dataset/ivslab_train/Annotations/All")
    for line in fr.readlines():
        #fwi.write("../dataset/ivslab_train/JPEGImages/" + line[:-1] + ".jpg\n")
        fwi.write("../../dataset/ivslab_train/JPEGImages/" + line.replace("\n", "") + ".jpg\n")
        fwl.write("../../dataset/ivslab_train/Annotations/" + line.replace("\n", "") + ".txt\n")
